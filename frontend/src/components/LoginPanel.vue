...
const panelTitle = computed(() => (isLoginMode.value ? "登录 AI 编程助手" : "注册 AI 编程助手账号"));
const panelSubtitle = computed(() =>
  isLoginMode.value
    ? "登录后即可恢复你的会话、消息和流式对话状态。"
    : "先创建一个账号，再继续使用会话、历史消息和对话功能。"
);
    ...
    <main class="auth-card">
      ...
      <section class="auth-panel">
        ...
        <div class="auth-form">
          ...
          <button class="auth-submit" type="button" :disabled="loading" @click="handleSubmit">
